  ...
  return (
    <>
      ...
      <div className="benefits-list">
        ...
        <p>✅ Measuring your blood caffein levels</p>
      ...
      <div className="card info-card">
        ...
        <p>This means that after 5 hours half the caffein you consume is still in your system keeping you alert longer! So if you drink a cup of coffee with 200mg of caffein, 5 hours later, you&apos;ll still have about 100 mg of caffein in your system.</p>
      </div>
    </>
  )
}